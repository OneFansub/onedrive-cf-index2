...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'beatz.anime@falabellape.onmicrosoft.com',

  // [OPTIONAL] This is the website icon to the left of the title inside the navigation bar. It should be placed under the
  // /public directory of your GitHub project (not your OneDrive folder!), and referenced here by its relative path to /public.
  icon: '/icons/beatz-anime-ico2.png',

  // The name of your website. Present alongside your icon.
  title: "BeatZ-Anime",

  // The folder that you are to share publicly with onedrive-cf-index-ng. Use '/' if you want to share your root folder.
  baseDirectory: process.env.BASE_DIRECTORY || '/Anime',
  ...
  footer:
    'Creado por <a href="https://github.com/lyc8503/onedrive-cf-index-ng" target="_blank" rel="noopener noreferrer">lyc8503</a>. ❤ | Worker de BeatZ-Anime',
  ...
  email: 'mailto:beatz.animes@gmail.com',
  ...
  links: [
    ...
    {
      name: 'Facebook',
      link: 'https://www.facebook.com/BeatZ-Anime-115459876894216',
    },
  ],
